...
" Base colors.
let s:colors.base0 = { 'gui': '#333333', 'cterm': 8 }
let s:colors.base1 = { 'gui': '#cc0000', 'cterm': 0 }
let s:colors.base2 = { 'gui': '#4e9a06', 'cterm': 10 }
let s:colors.base3 = { 'gui': '#c4a000', 'cterm': 12 }
let s:colors.base4 = { 'gui': '#3465a4', 'cterm': 11 }
let s:colors.base5 = { 'gui': '#75507b', 'cterm': 14 }
let s:colors.base6 = { 'gui': '#06989a', 'cterm': 7 }
let s:colors.base7 = { 'gui': '#d3d7cf', 'cterm': 15 }

" Other colors.
let s:colors.red     = { 'gui': '#f15e22', 'cterm': 9  }
let s:colors.orange  = { 'gui': '#333333', 'cterm': 1  }
let s:colors.yellow  = { 'gui': '#4e9a06', 'cterm': 3  }
let s:colors.magenta = { 'gui': '#c4a000', 'cterm': 13 }
let s:colors.violet  = { 'gui': '#3465a4', 'cterm': 5  }
let s:colors.blue    = { 'gui': '#75507b', 'cterm': 4  }
let s:colors.cyan    = { 'gui': '#06989a', 'cterm': 6  }
let s:colors.green   = { 'gui': '#d3d7cf', 'cterm': 2  }
...
call s:Col('Normal', 'base7', s:background)
...
call s:Col('LineNr', 'base3', s:linenr_background)
...
call s:Col('pythonOperator', 'violet')
